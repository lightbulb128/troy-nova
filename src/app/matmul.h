...
namespace troy { namespace linear {
    ...
    public:
        ...
        Plain2d encode_weights_uint64s(const BatchEncoder& encoder, const uint64_t* weights, bool for_cipher) const;
        Plain2d encode_weights_doubles(const CKKSEncoder& encoder, const double* weights, std::optional<ParmsID> parms_id, double scale, bool for_cipher) const;
        template <typename T>
        ...
        Plain2d encode_inputs_uint64s(const BatchEncoder& encoder, const uint64_t* inputs, bool for_cipher) const;
        Plain2d encode_inputs_doubles(const CKKSEncoder& encoder, const double* inputs, std::optional<ParmsID> parms_id, double scale, bool for_cipher) const;
        template <typename T>
