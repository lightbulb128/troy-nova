...
void example_ckks_basics()
{
    ...
    */
    ...
    encoder.encode_float64_single(3.14159265, std::nullopt, scale, plain_coeff3);
    encoder.encode_float64_single(0.4, std::nullopt, scale, plain_coeff1);
    ...
    */
    ...
    cout << "    + Modulus chain index for x3_encrypted: "
         << context->get_context_data(x3_encrypted.parms_id()).value()->chain_index() << endl;
    cout << "    + Modulus chain index for x1_encrypted: "
         << context->get_context_data(x1_encrypted.parms_id()).value()->chain_index() << endl;
    cout << "    + Modulus chain index for plain_coeff0: "
         << context->get_context_data(plain_coeff0.parms_id()).value()->chain_index() << endl;
    cout << endl;
    ...
    */
    ...
    ParmsID last_parms_id = x3_encrypted.parms_id();
    evaluator.mod_switch_to_inplace(x1_encrypted, last_parms_id);
    evaluator.mod_switch_plain_to_inplace(plain_coeff0, last_parms_id);
    ...
    */
    ...
    vector<complex<double>> true_result;
    for (size_t i = 0; i < input.size(); i++)
    {
        complex<double> x = input[i];
        true_result.push_back((3.14159265 * x * x + 0.4) * x + 1.0);
    }
