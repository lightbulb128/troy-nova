...
void example_bfv_basics()
{
    ...
    */
    ...
    In troy, we also create the BatchEncoder for BFV and convey both of them to
    device memory.
    */
    ...
    */
    ...
    uint64_t x = 6;
    Plaintext x_plain;
    encoder.encode_polynomial({x}, x_plain);
    ...
    */
    ...
    coeff_modulus. The number of polynomials in a ciphertext is called its `polynomial_count'
    and is given by Ciphertext::polynomial_count(). A freshly encrypted ciphertext always
    has size 2.
    */
    ...
    */
    ...
    Plaintext plain_one;
    encoder.encode_polynomial({1}, plain_one);
    ...
    */
    ...
    encoder.encode_polynomial({4}, plain_four);
